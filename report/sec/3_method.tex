...
We experiment with unfreezing the last few transformer blocks together with the final normalization layer. In particular, for
DINOv2 we report results obtained by unfreezing the last transformer layer and the normalization layer. For SAM, we fine-tune the last 2 layers and the neck component
while keeping the remaining layers of the encoder frozen. This design allows the model to adapt to correspondence-specific cues while preserving most of the general semantic
