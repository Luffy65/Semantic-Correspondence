...
We evaluate a training-free correspondence pipeline on the SPair-71k benchmark~\cite{min2019spair}, comparing popular backbones including
DINOv2~\cite{oquab2023dinov2}, DINOv3~\cite{simeoni2025dinov3}, and Segment Anything~\cite{kirillov2023segment}.
We further analyze the effect of light fine-tuning of the final backbone layers using a contrastive objective and investigate an improved prediction
strategy based on windowed soft-argmax~\cite{zhang2024telling}.

Our experiments show that fine-tuned DINO-based models significantly outperform SAM for semantic correspondence. In particular,
DINOv3 achieves a PCK@0.1 of \textbf{75.77\%}, slightly improving over DINOv2 (\textbf{74.89\%}), while DINOv2 attains the highest accuracy at
stricter thresholds, reaching \textbf{60.02\%} at PCK@0.05. Compared to training-free baselines, fine-tuning yields consistent improvements
