...
To assess generalization across domains, we additionally evaluated our approach on the PF-Willow dataset. Despite differences in image characteristics
and annotation protocols compared to SPair-71k, the proposed method maintains competitive correspondence performance, indicating that the learned
representations capture transferable semantic structures beyond the training distribution.
%[…]
